...
//- (void) processEncodedData:(NSData*)data presentationTimestamp:(int64_t)pts streamIndex:(NSUInteger)streamIndex isKeyFrame:(BOOL)isKeyFrame; // TODO refactor this
