...
- (void) encodeFrame:(CMSampleBufferRef) sampleBuffer andPTS:(CMTime)samplePts; //add by tzx
//- (void) encodeFrame:(CMSampleBufferRef) sampleBuffer andPTS:(int64_t)samplePts; //add by tzx
